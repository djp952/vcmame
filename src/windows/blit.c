...
static void generate_blitter(const struct win_blit_params *blit)
{
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////
	// 2018.12.22 MGB - Temporary hack so the dynamically loaded blitters can be executed
	DWORD prev = 0;
	BOOL result = VirtualProtect(fastptr, sizeof(active_fast_blitter), PAGE_EXECUTE_READWRITE, &prev);
	result = VirtualProtect(updateptr, sizeof(active_update_blitter), PAGE_EXECUTE_READWRITE, &prev);
	//////////////////////////////////////////////////////////////////////////////////////////////////
